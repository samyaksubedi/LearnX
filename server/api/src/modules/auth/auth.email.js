      ...
      <body>
        <div class="wrapper">
          ...
          <div class="body">
            ...
            <p>See you on the other side,<br/><strong>The LearnX Team</strong></p>
          </div>
...
const sendWelcomeEmail = async ({ to, name, verificationToken }) => {
  ...
  const { html, text } = getEmailShell({
    ...
    introParagraph: `We're thrilled to have you join LearnX. One last step — please verify your email address to activate your account.`,
  });

  return sendEmail({
    to,
    subject: 'Welcome to LearnX — Please Verify Your Email',
    html,
    text,
  });
};
